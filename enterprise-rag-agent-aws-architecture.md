...
agent deployed on AWS. The system enables employees to query internal knowledge bases — 
HR policies, IT runbooks, compliance docs, engineering wikis, SOPs — using natural language, 
